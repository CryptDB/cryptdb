...
create index ndx_customer_name on customer (c_w_id, c_d_id, c_last, c_first);
alter table oorder add constraint pk_oorder  primary key (o_w_id, o_d_id, o_id);
create unique index ndx_oorder_carrier on oorder (o_w_id, o_d_id, o_carrier_id, o_id);
